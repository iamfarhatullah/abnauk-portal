...
if (isset($_POST['submitDetails'])) {
	...
	$sql = "INSERT INTO `tbl_profile`(`profile_first_name`, `profile_last_name`, `profile_phone`, `profile_picture`, `user_FK`) VALUES ('$first_name','$last_name','$phone','$imagepath','$user_id')";
