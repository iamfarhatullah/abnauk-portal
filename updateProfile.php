...
if (isset($_POST['updateProfile'])) {
    ...
    $sql = "UPDATE `tbl_profile` SET `profile_first_name`='".$first_name."', `profile_last_name`='".$last_name."', `profile_phone`='".$phone."', `profile_picture`='".$finalImage."' WHERE profile_ID='".$id."'";
