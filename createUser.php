					...
					<div class="form-wrapper">
						...
						<form action="submitUser.php" method="post">
							...
							<div class="row">
								...
								<div class="col-md-6 col-sm-9">
									<input type="text" class="form-field" name="designation" placeholder="Enter designation" required><br>
								</div>
							</div>
							<br>
							<div class="row">
								<div class="col-md-2 col-sm-3">
									<label class="pull-left">Create password *</label>		
								</div>
								<div class="col-md-6 col-sm-9">
							...
							<div class="row" style="visibility: hidden;">
								<div class="col-md-2 col-sm-3">
									<label class="pull-left">Assign Role *</label>		
								</div>
								<div class="col-md-6 col-sm-9">
									<input type="radio" id="createUpdateDelete" value="1" name="permissions">
									<label for="createUpdateDelete">Admin</label>
									<span style="padding: 10px;"></span>
									<input type="radio" id="createUpdate" value="2" name="permissions">
									<label for="createUpdate">Moderator</label>
									<span style="padding: 10px;"></span>
									<input type="radio" id="createOnly" value="3" name="permissions" checked>
									<label for="createOnly">Viewer</label>
								</div>
							</div>
							<hr>
							<div class="row">
