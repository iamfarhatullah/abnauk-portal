...
if (isset($_POST['submitUser'])) {
	...
	if (mysqli_num_rows($resultCheckEmail)> 0 || mysqli_num_rows($resultCheckUsername)>0) {
		...
		$sql = "INSERT INTO `tbl_users`(`user_username`, `user_email`, `user_password`, `user_designation`, `user_permissions`) VALUES ('$username','$email','$password', '$designation','$permission')";
